...
FIG_HEIGHT = 3.5
FONT_SIZE = 15
LABEL_FONT_SIZE = FONT_SIZE + 4
CONFIDENCE_BAND_OPACITY = 0.2

FCQUIC_COLOR = COLORS[1]
FCQUIC_LINESTYLE = LINESTYLES[0]
FCQUIC_MARKER = MARKERS[0]

FCQUIC_FEC_COLOR = COLORS[3]
FCQUIC_FEC_LINESTYLE = LINESTYLES[2]
FCQUIC_FEC_MARKER = MARKERS[1]

BASELINE_QUIC_COLOR = COLORS[2]
BASELINE_QUIC_LINESTYLE = LINESTYLES[3]
BASELINE_QUIC_MARKER = MARKERS[2]

BASELINE_TCP_COLOR = COLORS[4]
BASELINE_TCP_LINESTYLE = LINESTYLES[4]
BASELINE_TCP_MARKER = MARKERS[3]

# same as FCQUIC_FEC because that version won't be used anymore
BASELINE_TCP_NO_TLS_COLOR = COLORS[3]
BASELINE_TCP_NO_TLS_LINESTYLE = LINESTYLES[3]
BASELINE_TCP_NO_TLS_MARKER = MARKERS[1]

TOKIO_QUICHE_COLOR = COLORS[0]
TOKIO_QUICHE_LINESTYLE = LINESTYLES[5]
TOKIO_QUICHE_MARKER = MARKERS[4]
